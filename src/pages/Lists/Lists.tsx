      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 btn-gold rounded-xl text-sm font-medium transition-colors cursor-pointer"
          >
        ...
        {showForm && (
          <form
            ...
            className="bg-[#0f0f14] border border-[#27272f] rounded-2xl p-6 mb-8 space-y-4"
          >
            <div>
            ...
            <div className="flex gap-3">
              <button
                type="submit"
                disabled={creating}
                className="px-6 py-2 btn-gold rounded-xl text-sm font-medium transition-colors cursor-pointer"
              >
              ...
              <button
                ...
                className="px-6 py-2 bg-[#18181f] text-zinc-300 rounded-xl text-sm font-medium transition-colors cursor-pointer"
              >
                Cancelar
              </button>
            </div>
        ...
        {loading ? (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <Link to={`/lists/${list.id}`} className="flex-1">
                    <h3 className="text-white font-semibold text-lg hover:text-gold-300 transition-colors">
                      {list.name}
                    </h3>
                    {list.description && (
                  ...
                  <button
                    ...
                    className="text-zinc-600 hover:text-red-400 transition-colors cursor-pointer ml-2"
                  >
          ...
          <div className="text-center py-12">
            <ListIcon className="w-12 h-12 text-zinc-700 mx-auto mb-4" />
